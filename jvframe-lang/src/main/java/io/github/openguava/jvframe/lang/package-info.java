 ...
 * However {@link io.github.openguava.jvframe.lang.CharSet} is not currently guaranteed thread-safe under all circumstances.</p>
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link io.github.openguava.jvframe.lang.math}, {@link io.github.openguava.jvframe.lang.concurrent} and {@link io.github.openguava.jvframe.lang.builder}.
 ...
 * The first is {@link io.github.openguava.jvframe.lang.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link io.github.openguava.jvframe.lang.RandomStringUtils} and {@link io.github.openguava.jvframe.lang.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link io.github.openguava.jvframe.lang.StringUtils#capitalize(String)}, {@link io.github.openguava.jvframe.lang.StringUtils#substringBetween(String, String)}/{@link io.github.openguava.jvframe.lang.StringUtils#substringBefore(String, String) Before}/{@link io.github.openguava.jvframe.lang.StringUtils#substringAfter(String, String) After}, {@link io.github.openguava.jvframe.lang.StringUtils#split(String)} and {@link io.github.openguava.jvframe.lang.StringUtils#join(Object[])} are good methods to begin with.</p>
 *
 ...
 * {@link io.github.openguava.jvframe.lang.CharUtils} exists for this purpose, while {@link io.github.openguava.jvframe.lang.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link io.github.openguava.jvframe.lang.CharRange} and {@link io.github.openguava.jvframe.lang.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link io.github.openguava.jvframe.lang.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment. </p>
 *
 ...
 *
 * <p>Would you believe it, {@link io.github.openguava.jvframe.lang.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link io.github.openguava.jvframe.lang.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link io.github.openguava.jvframe.lang.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link io.github.openguava.jvframe.lang.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * </pre>
 *
 * <p>Our final util class is {@link io.github.openguava.jvframe.lang.BooleanUtils}.
 * It contains various Boolean acting methods, probably of most interest is the {@link io.github.openguava.jvframe.lang.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link io.github.openguava.jvframe.lang.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link io.github.openguava.jvframe.lang.Validate} class may be used for assertions (remember, we support Java 1.2). </p>
 *
 * @since 1.0
 */
package io.github.openguava.jvframe.lang;
