 ...
 * These include classes to a {@link io.github.openguava.jvframe.lang.math.Fraction} class, various utilities for random numbers, and the flagship class, {@link io.github.openguava.jvframe.lang.math.NumberUtils} which contains a handful of classic number functions.</p>
 *
 * <p>There are two aspects of this package that should be highlighted.
 * The first is {@link io.github.openguava.jvframe.lang.math.NumberUtils#createNumber(String)}, a method which does its best to convert a String into a {@link java.lang.Number} object.
 ...
 * NumberUtils also has a related {@link io.github.openguava.jvframe.lang.math.NumberUtils#isCreatable(String)} method.</p>
 *
 * @since 2.0
 */
package io.github.openguava.jvframe.lang.math;
